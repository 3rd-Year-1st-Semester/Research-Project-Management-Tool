...
export const withRouter = (WrappedComponent) => (props) => {
  ...
  class TopicResult2 extends Component {
  ...
  onSubmit(e) {
    ...
    console.log(newRejectedTopic);
 
    
    axios
      .post(
        "http://localhost:7000/TopicRejected/send",newRejectedTopic
      )
...
<br/><br/><br/><br/><br/>
<div class="card">
        <h3 align="center">Rejecting Topic Registration Details</h3>
...
export default withRouter(TopicResult2);
