    ...
    return (
        <div>
            ...
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Download page</h1>
                    <p class="lead">Download Assignment document/presentation templates</p>
                </div>
            </div>
            ...
            <div className="container-fluid" >
                ...
                <div >
                    ...
                    <div className="col-6">
                        <h4 className="text-success font-weight-bold">Downloadable Files </h4>
                        <br />
...
export default FileStudentView;
